...
Librarian: So your task for today is to decide in which house you want to go. Therefore you have to do different tasks for each house to decide.
You: Alright! Where do I start?
Librarian: At first you have to go threw the big gate.. but the handle is lost. Maybe you can find it? Go search near the big cauldron because I couldn't find it here. 
You: Well.. that sounds easy!
-> END

= gate_running
Librarian: Did you found the handle?
