...
public class SettingsMenu : MonoBehaviour
{
    ...
    public const string MoseSensitivityKey = "Settings.Controls.Sensititvity.Mouse";
    public const string ControllerSensitivityKey = "Settings.Controls.Sensititvity.Controller";
    ...
    private void Awake()
    {
        ...
        Initialize(mouseSensitivitySlider, MoseSensitivityKey, DefaultMouseSensitivity);
